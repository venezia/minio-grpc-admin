...
go-bindata-assetfs -pkg protobuf -o ${PROJECT_DIRECTORY}/pkg/generated/ui/data/protobuf/bindata.go -prefix ${PROJECT_DIRECTORY}/api/minio-grpc-admin-spec/api ${PROJECT_DIRECTORY}/api/minio-grpc-admin-spec/api/...
